...
const CH_ORDER = ["Allegro", "Erli", "Studio-Bay", "Klaudia", "Proformy zrealizowane", "I-CC.PL", "Veluxa.eu", "Acti4med.pl"];
const CH_COLORS: Record<string, string> = {
  "Allegro": "oklch(0.70 0.17 45)",
  "Erli": "oklch(0.72 0.12 185)",
  "Studio-Bay": "oklch(0.62 0.17 300)",
  "Klaudia": "oklch(0.66 0.14 255)",
  // Zamówienia z integracji API/Make na Acti — wcześniej doklejane do Klaudii.
  // Odcień pokrewny, żeby wykresy historyczne dało się porównać wzrokiem.
  "Proformy zrealizowane": "oklch(0.60 0.11 230)",
  "I-CC.PL": "var(--accent)",
        ...
        <table style={tbl}>
          ...
          <tbody>
            {sorted.length === 0 ? (
              ...
              <tr key={c.channel} style={c.is_internal ? { opacity: 0.45 } : undefined}>
                <td style={td}>
                ...
                <td style={{ ...td, minWidth: 150 }}>
                  {c.is_internal ? (
                    <span style={{ fontSize: 11, color: "var(--text-lo)", fontStyle: "italic" }}>
                      obrót wewnętrzny — poza KPI
                    </span>
                  ) : (
