...
TOOLS: List[Dict[str, Any]] = [
    ...
    },
    {
        ...
        "function": {
            ...
            "description": ("Udział kanałów sprzedaży (Allegro / Erli / Studio-Bay / Klaudia / Proformy zrealizowane (tylko Acti, integracja API/Make) / własny sklep: I-CC.PL dla AMH, Veluxa.eu dla Veluxa, Acti4med.pl dla Acti): przychód i sztuki. "
