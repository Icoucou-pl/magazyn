...
function Brand({ stacked }: { stacked?: boolean }) {
  if (stacked) {
    return (
      <div style={{ display: "flex", flexDirection: "column", gap: 3, flexShrink: 0, lineHeight: 1 }}>
        <span className="mono" style={{ fontSize: 11, fontWeight: 600, color: "var(--text-mid)", letterSpacing: "0.12em" }}>MAG2.0</span>
  ...
  return (
    <div style={{ display: "flex", alignItems: "center", gap: 12, flexShrink: 0 }}>
      ...
      <span className="mono" style={{ fontSize: 15, fontWeight: 600, color: "var(--text-mid)", letterSpacing: "0.08em", paddingLeft: 12, borderLeft: "1px solid var(--border)" }}>
        MAG2.0
      </span>
    </div>
  );
