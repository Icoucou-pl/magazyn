...
export const I = {
  ...
  Container: (p: IconProps) => <Icon {...p}><rect x="2" y="7" width="20" height="10" rx="1"/><path d="M6 7v10M10 7v10M14 7v10M18 7v10"/></Icon>,
  ...
  History:   (p: IconProps) => <Icon {...p}><path d="M3 12a9 9 0 1 0 3-6.7L3 8"/><path d="M3 3v5h5M12 7v5l3 2"/></Icon>,
  Moon:      (p: IconProps) => <Icon {...p}><path d="M21 12.8A9 9 0 1 1 11.2 3a7 7 0 0 0 9.8 9.8z"/></Icon>,
  Customs:   (p: IconProps) => <Icon {...p}><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/><path d="M9 12l2 2 4-4"/></Icon>,
};
...
export const CONTAINER_STATUS_META: Record<string, ContainerStatusMeta> = {
  ...
  CUSTOMS:       { label: "Odprawa celna", fg: "var(--warning)", dot: "var(--warning)" },
